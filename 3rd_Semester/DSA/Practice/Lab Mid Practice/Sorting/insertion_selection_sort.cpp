...
public:
    ...
    void insertion_Sort()
    {
        ...
        {
            int key_value = current->data;
            Node *pre_node = current->prev;

            while (pre_node != nullptr && pre_node->data > key_value)
            {
                pre_node->next->data = pre_node->data;
